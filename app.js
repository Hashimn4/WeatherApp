...
button.addEventListener('click', () => {
    /*fetch('https://api.openweathermap.org/data/2.5/onecall?lat=31.5656822&lon=74.3141829&exclude=minutely&units=imperial&appid=2ef63409c26db0c35577b6754e514bb6')
    .then(res => res.json())
    .then(data => 
        h1.innerHTML = data.current.temp + " degrees Faranheit");
}*/
